import {
  require_classnames,
  require_prop_types
} from "./chunk-OMRYHLSS.js";
import "./chunk-MELSPDQ3.js";
import {
  __commonJS,
  __toESM,
  require_react
...
var Button = function Button2(_ref2) {
  var children = _ref2.children, className = _ref2.className, icon3 = _ref2.icon, border = _ref2.border, labelPosition = _ref2.labelPosition, rest = _objectWithoutProperties4(_ref2, _excluded4);
  ...
  }), lPos === "left" && children, icon3, lPos === "right" && children);
};
...
function _setPrototypeOf(o, p2) {
  _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf6(o2, p3) {
    o2.__proto__ = p3;
    return o2;
  };
...
function getIconName(familyPrefix, cls2) {
  var parts = cls2.split("-");
  var prefix2 = parts[0];
...
function getCanonicalIcon(values) {
  ...
  var canonical = values.reduce(function(acc, cls2) {
    var iconName = getIconName(config.familyPrefix, cls2);
    if (styles[cls2]) {
      cls2 = LONG_STYLE.includes(cls2) ? LONG_STYLE_TO_PREFIX[cls2] : cls2;
      givenPrefix = cls2;
      acc.prefix = cls2;
    } else if (PREFIXES.indexOf(cls2) > -1) {
      givenPrefix = cls2;
      acc.prefix = getCanonicalPrefix(cls2);
    } else if (iconName) {
      acc.iconName = iconName;
    } else if (cls2 !== config.replacementClass) {
      acc.rest.push(cls2);
    }
...
var parse = {
  icon: function icon(_icon) {
    ...
    if (_typeof4(_icon) === "object" && _icon.prefix && _icon.iconName) {
      return {
        prefix: _icon.prefix,
...
var mutators = {
  ...
  nest: function nest(mutation) {
    ...
    if (abstract[0].attributes.class) {
      var splitClasses = abstract[0].attributes.class.split(" ").reduce(function(acc, cls2) {
...
function normalizeIconArgs(icon3) {
  if (icon3 && _typeof5(icon3) === "object" && icon3.prefix && icon3.iconName && icon3.icon) {
    return icon3;
  }
  if (parse$1.icon) {
  ...
  if (icon3 && _typeof5(icon3) === "object" && icon3.prefix && icon3.iconName) {
    return icon3;
  }
...
var EllipsisButton = function EllipsisButton2(_ref2) {
  ...
  var icon3 = orientation === "vertical" ? import_faEllipsisV.faEllipsisV : import_faEllipsisH.faEllipsisH;
...
function _setPrototypeOf2(o, p2) {
  _setPrototypeOf2 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf6(o2, p3) {
    o2.__proto__ = p3;
    return o2;
  };
...
var MessageTextContent = function MessageTextContent2(_ref2) {
  var text2 = _ref2.text, className = _ref2.className, children = _ref2.children;
...
function _setPrototypeOf3(o, p2) {
  _setPrototypeOf3 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf6(o2, p3) {
    o2.__proto__ = p3;
    return o2;
  };
...
function _setPrototypeOf4(o, p2) {
  _setPrototypeOf4 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf6(o2, p3) {
    o2.__proto__ = p3;
    return o2;
  };
...
var ContentEditable = function(_Component) {
  ...
  function ContentEditable2(props) {
    ...
    _defineProperty11(_assertThisInitialized3(_this), "handleInput", function(evt) {
      var _assertThisInitialize3 = _assertThisInitialized3(_this), onChange4 = _assertThisInitialize3.props.onChange;
      var target = evt.target;
      onChange4(target.innerHTML, target.textContent, target.innerText);
    });
...
function _setPrototypeOf5(o, p2) {
  _setPrototypeOf5 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf6(o2, p3) {
    o2.__proto__ = p3;
    return o2;
  };
...
function MessageInputInner(_ref2, ref) {
  var value = _ref2.value, onSend = _ref2.onSend, onChange4 = _ref2.onChange, autoFocus = _ref2.autoFocus, placeholder = _ref2.placeholder, fancyScroll = _ref2.fancyScroll, className = _ref2.className, activateAfterChange = _ref2.activateAfterChange, disabled2 = _ref2.disabled, sendDisabled = _ref2.sendDisabled, sendOnReturnDisabled = _ref2.sendOnReturnDisabled, attachDisabled = _ref2.attachDisabled, sendButton = _ref2.sendButton, attachButton = _ref2.attachButton, onAttachClick = _ref2.onAttachClick, rest = _objectWithoutProperties32(_ref2, _excluded210);
  ...
  var handleChange = function handleChange2(innerHTML, textContent, innerText) {
    ...
    var content = getContent();
    onChange4(innerHTML, textContent, innerText, content[2]);
  };
...
var ExpansionPanel = function ExpansionPanel2(_ref2) {
  var children = _ref2.children, title = _ref2.title, defaultOpen = _ref2.open, isOpened = _ref2.isOpened, onChange4 = _ref2.onChange, className = _ref2.className, rest = _objectWithoutProperties39(_ref2, _excluded39);
  ...
  var icon3 = opened === true ? import_faChevronDown.faChevronDown : import_faChevronLeft.faChevronLeft;
  var handleOpen = (0, import_react45.useCallback)(function(e) {
    if (typeof isOpened === "boolean") {
      onChange4 === null || onChange4 === void 0 ? void 0 : onChange4(e);
    } else {
      setOpen(!opened);
      onChange4 === null || onChange4 === void 0 ? void 0 : onChange4(!opened, e);
    }
  }, [onChange4, open, opened, isOpened]);
...
function SearchInner(_ref2, ref) {
  var placeholder = _ref2.placeholder, value = _ref2.value, onChange4 = _ref2.onChange, onClearClick2 = _ref2.onClearClick, className = _ref2.className, disabled2 = _ref2.disabled, rest = _objectWithoutProperties41(_ref2, _excluded41);
...
function StatusListInner(_ref2, ref) {
  var className = _ref2.className, children = _ref2.children, size = _ref2.size, selected = _ref2.selected, onChange4 = _ref2.onChange, itemsTabIndex = _ref2.itemsTabIndex, rest = _objectWithoutProperties44(_ref2, _excluded44);
